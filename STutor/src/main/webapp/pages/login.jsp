	...
	<div class="jumbotron home home-fullscreen" id="home">
		...
		<div class="container">
			<div class="header-info">
				...
				<p>
					STutor helps you to find private tutors and to be sure that tutor
					is actually good at the subject!<br> Our client reviews mean
					you can select private tutors who will lift your grade, raise
					confidence<br> and help you to discover the joy of learning
					through their private tuition journey.
				</p>
			</div>
		</div>
	</div>
